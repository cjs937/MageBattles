...
// End Cross Module References
...
#endif
		static const UE4CodeGen_Private::FStructPropertyParams NewProp_testVal;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AAbilityScript_Statics::NewProp_testVal_MetaData[] = {
		{ "Category", "AbilityScript" },
		{ "ModuleRelativePath", "AbilityScript.h" },
	};
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AAbilityScript_Statics::NewProp_testVal = { UE4CodeGen_Private::EPropertyClass::Struct, "testVal", RF_Public|RF_Transient|RF_MarkAsNative, (EPropertyFlags)0x0010000000000001, 1, nullptr, STRUCT_OFFSET(AAbilityScript, testVal), Z_Construct_UScriptStruct_FVMValue, METADATA_PARAMS(Z_Construct_UClass_AAbilityScript_Statics::NewProp_testVal_MetaData, ARRAY_COUNT(Z_Construct_UClass_AAbilityScript_Statics::NewProp_testVal_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AAbilityScript_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AAbilityScript_Statics::NewProp_testVal,
	...
	IMPLEMENT_CLASS(AAbilityScript, 686733446);
